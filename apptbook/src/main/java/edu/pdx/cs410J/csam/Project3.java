...
public class Project3 {
    ...
    /**
     * The main method for the CS410J appointment book Project 3.
     ...
     * May also contain flag to dump to a text file in a slightly more attractive format.
     */
    public static void main(String[] args) {
        ...
        switch (args.length) {
            ...
            case (7):
                ...
                if (args[0].equals("-README")) {
                    ...
                    System.err.println("Invalid option: " + args[0] + ". Valid options are [-textFile file|-pretty file|-print|-README].");
                    System.exit(1);
                }

                break;

            //Required arguments + ((-README and -print) or (-textFile file) or (-pretty file))
            case (8):
                ownerInd = 2;
                descInd = 3;
                dateInd = 4;
                ...
                if (args[0].equals("-README") && args[1].equals("-print") || args[1].equals("-README") && args[0].equals("-print")) {
                    ...
                    System.err.println("Invalid format. The correct format is: [-textFile file|-pretty file|-print|-README] <name> <description> <start date> <start time> <end date> <end time>");
                    System.exit(1);
                }

                break;

            //Required arguments + ((-textFile file) or (-pretty file)) + one other option
            case (9):
                ownerInd = 3;
                descInd = 4;
                dateInd = 5;
                ...
                } else if (args[0].equals("-pretty") && args[2].equals("-print")) {
                    printFlag = 1;
                    prettyFlag = 1;
                    prettyInd = 1;
                    boolean check = new File(args[1]).exists();
            ...
            //Required arguments + ((-textFile file and -pretty file) or (-textFile file and -print and -README) or (-pretty file and -print and -README))
            case (10):
                ownerInd = 4;
                descInd = 5;
                dateInd = 6;
                ...
                if (args[0].equals("-README") && args[1].equals("-print") && args[2].equals("-textFile")
                        ...
                        || args[0].equals("-README") && args[1].equals("-print") && args[2].equals("-pretty")
                        || args[0].equals("-print") && args[1].equals("-README") && args[2].equals("-pretty")
                        || args[0].equals("-print") && args[1].equals("-pretty") && args[3].equals("-README")
                        || args[0].equals("-README") && args[1].equals("-pretty") && args[3].equals("-print")
                        || args[0].equals("-pretty") && args[2].equals("-print") && args[3].equals("-README")
                        || args[0].equals("-pretty") && args[2].equals("-README") && args[3].equals("-print")) {
                    printReadme();
            ...
            //Required arguments + (-textFile file and -pretty file and (-print or -README))
            case (11):
                ownerInd = 5;
                descInd = 6;
                dateInd = 7;
                ...
                if (args[0].equals("-README") && args[1].equals("-textFile") && args[3].equals("-pretty")
                        || args[0].equals("-README") && args[1].equals("-pretty") && args[3].equals("-textFile")
                        || args[0].equals("-textFile") && args[2].equals("-README") && args[3].equals("-pretty")
                        || args[0].equals("-pretty") && args[2].equals("-README") && args[3].equals("-textFile")
                        || args[0].equals("-textFile") && args[2].equals("-pretty") && args[4].equals("-README")
                        || args[0].equals("-pretty") && args[2].equals("-textFile") && args[4].equals("-README")) {
                    printReadme();
                } else if (args[0].equals("-print") && args[1].equals("-textFile") && args[3].equals("-pretty")) {
                    prettyInd = 4;
                    boolean check = new File(args[prettyInd]).exists();
                    if (!check) {
                        missingPrettyFlag = 1;
                    }

                    fileInd = 2;
                    check = new File(args[fileInd]).exists();
                    if (!check) {
                        missingFileFlag = 1;
                    }
            ...
            case (12):
                ...
                if (args[0].equals("-README") && args[1].equals("-print") && args[2].equals("-textFile") && args[4].equals("-pretty")
                        || args[0].equals("-print") && args[1].equals("-README") && args[2].equals("-textFile") && args[4].equals("-pretty")
                        || args[0].equals("-print") && args[1].equals("-textFile") && args[3].equals("-README") && args[4].equals("-pretty")
                        || args[0].equals("-README") && args[1].equals("-textFile") && args[3].equals("-print") && args[4].equals("-pretty")
                        || args[0].equals("-textFile") && args[2].equals("-print") && args[3].equals("-README") && args[4].equals("-pretty")
                        || args[0].equals("-textFile") && args[2].equals("-README") && args[3].equals("-print") && args[4].equals("-pretty")
                        || args[0].equals("-README") && args[1].equals("-print") && args[2].equals("-pretty") && args[4].equals("-textFile")
                        || args[0].equals("-print") && args[1].equals("-README") && args[2].equals("-pretty") && args[4].equals("-textFile")
                        || args[0].equals("-print") && args[1].equals("-pretty") && args[3].equals("-README") && args[4].equals("-textFile")
                        || args[0].equals("-README") && args[1].equals("-pretty") && args[3].equals("-print") && args[4].equals("-textFile")
                        || args[0].equals("-pretty") && args[2].equals("-print") && args[3].equals("-README") && args[4].equals("-textFile")
                        || args[0].equals("-pretty") && args[2].equals("-README") && args[3].equals("-print") && args[4].equals("-textFile")
                        || args[0].equals("-pretty") && args[2].equals("-print") && args[3].equals("-textFile") && args[5].equals("-README")
                        || args[0].equals("-print") && args[1].equals("-pretty") && args[3].equals("-textFile") && args[5].equals("-README")
                        || args[0].equals("-print") && args[1].equals("-textFile") && args[3].equals("-pretty") && args[5].equals("-README")
                        || args[0].equals("-pretty") && args[2].equals("-textFile") && args[4].equals("-print") && args[5].equals("-README")
                        || args[0].equals("-textFile") && args[2].equals("-print") && args[3].equals("-pretty") && args[5].equals("-README")
                        || args[0].equals("-textFile") && args[2].equals("-pretty") && args[4].equals("-print") && args[5].equals("-README")
                        || args[0].equals("-README") && args[1].equals("-textFile") && args[3].equals("-pretty") && args[5].equals("-print")
                        || args[0].equals("-textFile") && args[2].equals("-README") && args[3].equals("-pretty") && args[5].equals("-print")
                        || args[0].equals("-textFile") && args[2].equals("-pretty") && args[4].equals("-README") && args[5].equals("-print")
                        || args[0].equals("-README") && args[1].equals("-pretty") && args[3].equals("-textFile") && args[5].equals("-print")
                        || args[0].equals("-pretty") && args[2].equals("-textFile") && args[4].equals("-README") && args[5].equals("-print")
                        || args[0].equals("-pretty") && args[2].equals("-README") && args[3].equals("-textFile") && args[5].equals("-print")) {
                    printReadme();
                } else {
                    System.err.println("Invalid format. The correct format is: [-textFile file|-pretty file|-print|-README] <name> <description> <start date> <start time> <end date> <end time>");
                    System.exit(1);
            ...
            default:
                ...
                if (args.length > 12) {
                    if (args[0].equals("-README")) {
                        ...
                        System.err.println("Too many arguments/options. The correct format is: [-textFile file|-pretty file|-print|-README] <name> <description> <start date> <start time> <end date> <end time>");
                        System.exit(1);
                    }
                }
                //Too few arguments
                    ...
                    if (args.length == 0) {
                        System.err.println("Missing command line arguments. The correct format is: [-textFile file|-pretty file|-print|-README] <name> <description> <start date> <start time> <end date> <end time>");
                        System.exit(1);
                    }
                    if (args[0].equals("-README")) {
                        printReadme();
        ...
        if (fileFlag == 1) {
            ...
            TextDumper dumper = new TextDumper(args[fileInd], args[ownerInd]);
        ...
        //Dump to pretty file
        if(prettyFlag == 1) {
            PrettyPrinter printer = new PrettyPrinter(args[prettyInd], args[ownerInd]);
    ...
    private static void printReadme() {
        ...
        System.out.println();
        System.out.println("Usage: java edu.pdx.cs410J.csam.Project3 [-textFile file|-pretty file|-print|-README] <name> <description> <start date> <start time> <end date> <end time>");
        System.out.println("-----------------");
